  ...
  public: {
    Tables: {
      ...
      user_apps: {
        Row: {
          ...
          convex_dev_admin_key: string | null
          convex_dev_url: string | null
          convex_prod_admin_key: string | null
        ...
        Relationships: [
          {
            foreignKeyName: "user_apps_current_sandbox_id_fkey"
            columns: ["current_sandbox_id"]
            isOneToOne: false
            referencedRelation: "user_sandboxes"
            referencedColumns: ["id"]
          },
        ]
      }
      ...
      user_sandboxes: {
        Row: {
          ...
          app_id: string
          app_url: string | null
          expo_status: Database["public"]["Enums"]["expo_status"] | null
          id: string
    ...
    Enums: {
      app_status:
        ...
        | "success"
        | "deleted"
      deployment: "web" | "eas-update" | "freestyle"
      deployment_status: "failed" | "completed" | "uploading"
      expo_status: "starting" | "bundling" | "bundled"
