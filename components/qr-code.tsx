...
export function QRCodeDisplay({ url }: QRCodeDisplayProps) {
  ...
  useEffect(() => {
    const generateDownloadQR = async () => {
      try {
        const downloadUrl = isIOS ? "https://makexapp.link/in-web-download-ios" : "https://makexapp.link/in-web-download-android";
        ...
        <>
          ...
          <div className="text-sm text-muted-foreground text-center max-w-sm">
            ...
            <ol className="text-left space-y-2">
              ...
              )} from your device's app store</li>
        ...
        <DialogContent className="sm:max-w-md">
          ...
          <div className="flex flex-col items-center gap-6 py-4">
            ...
            <div className="flex gap-2 w-full">
              <a
                href={isIOS ? "https://makexapp.link/in-web-download-ios" : "https://makexapp.link/in-web-download-android"}
                target="_blank"
                rel="noopener noreferrer"
