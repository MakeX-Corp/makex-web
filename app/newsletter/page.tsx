      ...
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
            Master the art of vibecoding with curated tips, discover amazing products, 
            and connect with thriving communities. Join the movement that's changing how we code.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-8 items-center">
          ...
          <div className="space-y-6 order-2 md:order-1">
            <div className="flex items-start space-x-3">
              ...
              <div>
                ...
                <p className="text-muted-foreground">Level up your coding vibe with practical techniques and mindset shifts.</p>
              </div>
            </div>
            ...
            <div className="flex items-start space-x-3">
              ...
              <div>
                ...
                <p className="text-muted-foreground">Find tools, apps, and resources that enhance your vibecoding journey.</p>
              </div>
            </div>
            ...
            <div className="flex items-start space-x-3">
              ...
              <div>
                ...
                <p className="text-muted-foreground">Connect with vibrant coding communities and like-minded developers.</p>
              </div>
            </div>
            ...
            <div className="flex items-start space-x-3">
              ...
              <div>
                ...
                <p className="text-muted-foreground">Get early access to vibecoding trends and insider knowledge.</p>
              </div>
            </div>

            <div className="bg-primary/5 border border-primary/20 rounded-lg p-4">
              <p className="text-sm text-primary/80">
                <span className="font-semibold">Pure vibecoding content.</span> No spam, just good vibes. Unsubscribe anytime.
              </p>
            </div>
          </div>
          ...
          <div className="bg-card shadow-xl rounded-2xl p-8 border order-1 md:order-2">
            ...
            <p className="text-xs text-muted-foreground mt-4 text-center">
              ...
              <a href="https://www.makex.app/privacy" className="text-primary hover:text-primary/80 transition-colors" target="_blank" rel="noopener noreferrer">Privacy Policy</a>{' '}
              and{' '}
              <a href="https://www.makex.app/terms" className="text-primary hover:text-primary/80 transition-colors" target="_blank" rel="noopener noreferrer">Terms of Service</a>.
            </p>
          </div>
        </div>
      </div>
