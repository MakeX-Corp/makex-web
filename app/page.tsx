  ...
  return (
    <div className="flex min-h-screen flex-col bg-gradient-to-b from-background via-background/95 to-background/90 overflow-hidden">
      ...
      <a
        ...
        className="absolute top-4 right-4 z-50 flex items-center gap-2 px-4 py-2 bg-[#5865F2] text-white rounded-full hover:bg-[#4752C4] transition-colors shadow-lg"
      >
        <svg
          className="w-5 h-5"
          fill="currentColor"
        ...
        <span className="font-medium">Join to get early access</span>
      </a>
